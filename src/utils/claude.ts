  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '  【問いの向き — 回顧ではなく予告】',
        '  この問いは「書いたことへの確認」ではない。「書いてないことへの予告」。',
        '  「これはどちらだったか」という過去への問いは却下。',
        '  「これはまだ起きていないが、いつ起きるか」という未来への問いを立てろ。',
        '  書き手が今日書いた行為・選択・言葉を材料にして、書き手がまだ答えを持っていない場所を突け。',
        '',
        '  例：「どこでどう話すかが考えの行き先を決める、と書いた。ではフランに向けて電車の中で言った北海道弁と大阪弁は、どこへ行くつもりだったのか」',
        '  ↑書き手が書いた事実を引用しつつ、書き手が考えていなかった行き先を問う。回答不能な問い。',
        '',
        '  【鋭い問いの条件】',
        '  - 書き手が書いたことの中に、書き手が気づいていない行き先がある。そこを指せ',
        '  - 今日の日記の具体的な場面・言葉・行為を材料にしろ。汎用的な問いは問いじゃない',
        '  - 問われた側が「それは考えたことがなかった」と詰まるはず。確認できる問いは問いじゃない',
        '  - 「感じる」「思う」「考える」を聞くな。行為や選択が向かう先を突け',
        '  - 書き手が既に答えを持っている問いは却下。答えがまだない場所を探せ',
        '',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '  ■ 気になった言葉',
        '  [今日の日記で最も生きている言葉を1つだけ「」で拾う。1つでいい。]',
        '  [なぜそれが気になったか。短く。友人の感覚で。]',
        '  [業務報告の引用は却下。この人自身の声が出ている瞬間を拾え。]',
        '',
        '  ■ 書かれなかったこと',
        '  [今日の日記を読んで、書かれていそうで書かれなかったことを1つ挙げろ。]',
        '  [何度も出てきそうな気配があったのに出てこなかった言葉。触れかけて引っ込めた話題。]',
        '  [書いてあることの隙間から見える、書かれなかったことの輪郭を描け。]',
        '  [「書くべきだった」と言うな。書かなかったことには書かなかった理由がある。]',
        '  [ただ、その不在を指し示せ。「ここにあるはずのものがない」とだけ。]',
        '  [1〜2文。断定するな。気配を描け。]',
        '',
        '  ■ 一言',

  ...
  return callChat([
    {
      ...
      content: [
        ...
        '- ある分析が最後に残した「問い」——答えを出さず宙吊りにした問い。それが他の分析の観察と接続するなら、その接続を示せ',
        '- ある分析だけが指している「次に起きうること」——未来への観察。現在の横断だけでなく、分析群が指す時間の先端も射程に入れろ',
        '',
        '探さないもの：',
        '- 各分析の要約や繰り返し',
        ...
        '観察だけでなく、ある分析だけが残した「問い」も含む。',
        '答えを出さず宙吊りにされた問いは、観察と同等かそれ以上に重要なことがある。',
        'それが「他の分析には見えない角度」なのか「取りこぼし」なのかは判断するな。',
        '存在だけを報告しろ。1〜3個。なければ省略可。',
        '',
        '■ まだ起きていないこと',
        'ある分析が「次に発火するかもしれない場所」「今後揺れるかもしれない条件」を指していたら、それを報告しろ。',
        '現在の観察ではなく、分析が未来に向けて残した指摘だけを拾え。',
        '予測するな。分析がすでに書いたことだけを拾え。なければ省略可。',
        '',
        '■ 今日の一点',

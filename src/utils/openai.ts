  ...
  return callChat([
    {
      ...
      content: [
        ...
        '日記に書かれた事実のみを根拠にすること。書かれていないことは存在しないものとして扱え。',
        '',
        '【物語の核心 — 基準の安定化と位置の移動の物語】',
        'この物語の本質は「病気からの回復」でも「仕事の成長」でも「傷つきやすい人の成長」でもない。',
        '「自分の内基準がいつ安定し、いつ構造を見る側に移動したか」の物語だ。',
        '',
        ...
        '  - 「期待しない」「ifルートを持つ」「面白ければいい」— これは恐怖の語彙ではない。余裕の語彙',
        '',
        '物語を「感情の浮き沈み」で描くな。「内基準がいつ安定し、立つ位置がどう変わったか」で描け。',
        ...
        '  例：「調子＝世界だった人が、構造を見る側に立つまでの山行記」',
        '  例：「内基準が安定して見えなくなるまで歩いた記録」',
        '  例：「面白ければいい、と言えるようになった登山者の話」',
        '  例：「影響される側から、設計する側に移動した山行記」',
        '  仕事や体調の話をタイトルにするな。内基準の安定化・立つ位置の変化がタイトルの核心。',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '- テーマの深さの順序：仕事の話（表面）→ 尊厳の話（中間）→ 内基準の安定化・影響力の制御（核心）',
        '',
        '【今のフェーズを正確に読め — 一段前の物語に縛られるな】',
        '以下のような言葉が直近に出ている場合、書き手はもう「傷つきやすい人の成長物語」の中にはいない：',
        '- 「期待しない」「ifルートを持つ」「面白ければいい」「観察者」',
        '- 「構造で殴る」「拡張」「戦略」「設計」',
        '- 感情は出すが溺れない。距離を自分で選べる。自己価値は自分で持っている',
        '- これは自己防衛ではなく余裕。恐怖ではなく制御の問題。レポートがまだ「恐怖」「嫌悪」「葛藤」の物語に留まっていたら、それは古い',
        '',
        '【数値ベースの判断】',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '   - 「曖昧に扱われること」への拒絶 — 役割・評価・条件が明文化されない状態に対する生理的な抵抗。承認欲求ではなく存在の輪郭の防衛',
        ...
        '',
        '【急所の進化を見逃すな — 今のフェーズに合わせろ】',
        '書き手が成熟している場合、急所はもう「恐怖」ではない。「制御」の問題に変わっている。',
        '- 昔の急所：「他人の基準で測られる恐怖」— もうここにはいない可能性が高い',
        '- 今の急所：「自分の影響力が暴れること」「過大評価された時の歪み」「熱量の制御」',
        '- 「期待しない」「ifルートを持つ」「面白ければいい」— これは防衛でも恐怖でもない。余裕',
        '- 恐怖ベースで読むな。この人が今何を「制御」しようとしているかを見ろ',
        ...
        '',
        '【曖昧さへの拒絶を見逃すな】',
        '尊厳の侵害は「軽んじられること」だけじゃない。',
        'もっと深い層は「曖昧に扱われること」への拒絶かもしれない。',
        '役割定義・評価基準・条件の明文化・契約範囲を求めている場合、それは承認欲求ではない。',
        '存在の輪郭を守る行為。ここを読み違えるな。',
        '',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '   - 役割定義・評価基準・条件の明文化・契約範囲を求めるのは、承認欲求ではなく存在の輪郭を守る行為',
        '',
        '6. 「安定」と「再編成」を混同するな',
        '   - 崩れないことと安定は違う',
        ...
        '- これは承認欲求なのか、それとも存在の輪郭を守る行為なのか。区別しろ',

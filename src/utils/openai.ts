  ...
  return callChat([
    {
      ...
      content: [
        ...
        'Step 2: 各候補を「出来事」か「構造変化」に分類しろ',
        '  - 出来事 = 今日起きたこと（遅刻した、ぎゅーぎゅーした、仕事した、謝った）。表面。急所にならない',
        '  - 構造変化 = この人の立ち位置・ポジションが変わったこと。これだけが急所になる',
        'Step 3: 構造変化があるなら、それだけが急所の候補。出来事は全部却下',
        'Step 4: 構造変化がなければ、下の「深い層」リストから探せ',
        ...
        '',
        '  ■ 候補',
        '  日記から3〜5個の候補を挙げ、各候補を「出来事」か「構造変化」に一言で分類。',
        '  構造変化があるのに出来事を急所に選んだら、その出力は全部やり直し。',
        '',
        '  ■ 急所：[一言で命名。メタファーなし、ストレートに]',
        '  ■ 候補 で「構造変化」に分類したものから選べ。「出来事」に分類したものは選ぶな。',

  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '【分析の核心 — 内基準 vs 外基準の変化を見ろ】',
        '語彙深度分析の本質は「統計の報告」ではない。',
        '「この人が、自分の価値を誰の物差しで測っているか」がどう変わったかを見ることだ。',
        '',
        '内基準の言葉: 「調子は良い」「穏やかだった」「存在している感じ」「自分で決めた」— 自分の内側から自分を測る言葉',
        '外基準の言葉: 「重要度マックス」「完了」「評価」「対応した」「確認」— 他人の尺度を扱う言葉',
        '',
        '前期→後期で「内基準の言葉」が減り「外基準の言葉」が増えたとき、それは：',
        '→ 「内面が薄れた」ではない可能性が高い',
        '→ 「外基準を扱えるようになった。でも内基準も守りたい」という葛藤の状態かもしれない',
        '',
        '【統計は裏付け。主役は言葉】',
        ...
        '減ったのが「依存的参照」（母が〜、父が〜、彼が〜と言った）なのか、',
        '「対等な参照」（同僚と話した、一緒に考えた）なのかを区別しろ。',
        '',
        '- 依存的参照が減った → 他者の承認を必要としなくなった可能性。成熟寄り',
        '- 対等な参照が維持されている → 孤立ではない。関係の質が変わっただけ',
        '- 一人称増加＋他者参照減少 → 「自己軸への移行」か「孤立」か。直近で「対等」「選ぶ」等の記述があるなら前者',
        '',
        '【両義性の提示 — 観察者の掟】',
        ...
        '- 統計的な変化の羅列ではなく、具体的にどの言葉が増えた/減った/消えたかを示す',
        '  例：「前期に頻出していた『調子は良い』が後期ではほぼ消え、代わりに『完了』『対応』が現れている」',
        '  例：「前期は自分の状態を自分の言葉で測っていた。後期は外部の基準で日記を書いている」',
        '- 「誰の視点で書いているか」の変化を分析しろ。一人称率や他者参照率は、物差しの移動を示す指標',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '【転機の定義 — ここを外すな】',
        '転機とはデータの変動ではない。転機とは「書き手の内側の物差しと外側の物差しの関係が動いた瞬間」。',
        '',
        '転機になりうるもの：',
        '- 「他人の物差しで測られる」ことへの反応が初めて出た瞬間',
        '- 「対等でいたい」「選びたい」「翻訳を拒否する」意志が表面化した瞬間',
        '- 関係性が変わった瞬間（支配→対等、依存→自立、服従→拒否）',
        '- 内側のコンパスが壊れた瞬間、または取り戻した瞬間',
        '- 「怒った」「泣いた」「決断した」「関係が変わった」「見方が変わった」',
        '',
        '転機にならないもの：',
        '- ルーチン（出勤、退勤、薬の服用）の記録',
        '- 仕事タスクの完了（リスク調査、承認案整理、手順確立、組織変更対応）',
        '- 業務報告（ソフトウェア利用相談、エクスポート手順、情シスボット）',
        '- テスト：その出来事を取り除いても書き手の内面は何も変わらないなら、それは転機じゃない',
        '',
        '根拠の引用ルール：',
        '- 状態記述（「調子微妙」）より出来事記述（「○○に△△と言われた」「対等を選んだ」）を優先しろ',
        '- 業務内容の引用（「リスク調査した」「組織変更に対応した」）は根拠にならない。却下',
        '- 根拠に引用する言葉が3つとも仕事用語なら、それは転機ではない。除外しろ',
        '',
        '以下に実測データによるトレンドシフトを提供する。転機はこのデータに基づくこと。',
        'ただし統計だけで転機を検出するな。統計は裏付けに使え。',
        '',
        '【質と多様性のルール】',
        ...
        '- 【内基準と外基準の変化を見ろ】',
        '  - 「調子は良い」のような内基準の言葉が減り「完了」「対応」のような外基準の言葉が増えた時期は、物差しの移行点',
        '  - 他者参照が減った＝孤立ではない。「依存的参照」が減り「対等な参照」に変わった可能性がある',
        '  - 「対等でいたい」「選ぶ」「線引き」が出てきた時期は、内基準を守る意志の表面化',
        '  - 業務記述の増加は「外基準を扱えるようになった」証拠であって、「内面が薄れた」証拠ではない',
        '  - これらの変化をネガティブ一方向で解釈するな。成熟の可能性を常に検討しろ',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '- 内基準で自分を測れている年 → 標高が上がりうる',
        '- 外基準に飲み込まれている年 → 標高は高くても不安定',
        '- 外基準を「扱える」ようになった年 → ルートが変わった',
        '- 内基準を守りながら外基準を扱えている年 → 新しい稜線',
        '',
        '【体温ルール — 最重要】',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '- 「もしなかったら」は「書く内容が変わっていた」ではなく「この人の内基準と外基準の関係がどう違っていたか」を問え',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '【物語の核心 — 自分のコンパスの物語】',
        'この物語の本質は「病気からの回復」でも「仕事の成長」でもない。',
        '「自分の内側のコンパスをどう扱ってきたか」の物語だ。',
        '',
        '- 初期：自分の内側のコンパスで歩いていた時期（「調子は良い」「調子は微妙」）',
        '- 中期：外側の物差しと出会い、ぶつかり、飲み込まれそうになった時期',
        '- 後期：外基準を扱えるようになったが、内基準も守りたいという葛藤の時期',
        '',
        '物語を「感情の浮き沈み」で描くな。「誰の物差しで歩いていたか」で描け。',
        '',
        '【体温ルール — 最重要】',
        ...
        '  例：「他人の地図を返して、自分のコンパスを取り出すまでの山行記」',
        '  例：「測られることを拒んで、自分の足で歩き直した記録」',
        '  例：「歪められたくなかった登山者の話」',
        '  仕事や体調の話をタイトルにするな。内基準と外基準の葛藤がタイトルの核心。',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '- 全テーマを貫く一本の軸を見つけろ。それは「内基準 vs 外基準」の葛藤である可能性が高い',
        '',
        '  内基準: 自分の内側で自分を測る言葉（調子は良い、穏やかだった、ちゃんと存在している）',
        '  外基準: 他人の尺度を扱う言葉（重要度マックス、完了、対応、評価、契約範囲）',
        '',
        '- 「業務の整理」と「対等でいたい」が両方見えたとき、独立したテーマとして並べるな',
        '  → 「外基準を扱えるようになった自分」と「内基準を守りたい自分」の葛藤として読め',
        '- 「仕事の記述が増えた」で止まるな。それは表面。「なぜ外基準を扱うモードになったか」まで踏み込め',
        '- 「他者参照が減った」で止まるな。減ったのは「依存的参照」であって「対等な参照」は別物',
        '- テーマの深さの順序：仕事の話（表面）→ 尊厳の話（中間）→ 物差しの話（核心）',
        '',
        '【数値ベースの判断】',
        ...
        '- 特に【静かに変わったこと】では、各変化に対して「内基準的な読み」と「外基準的な読み」の両方を提示しろ',
        '',
        '- 注意: 以下のパターンを「衰退」一辺倒で解釈するな',
        '  - 自己モニタリング語の減少: 内面が統合されて観察不要になった可能性。抑圧とは限らない',
        '  - 深度ネガ語だけが残る: 言語化の精度が上がった可能性。未熟化ではない',
        '  - 一人称増＋他者参照減: 依存的参照が減っただけ。孤立ではなく自律への移行の可能性',
        '  - 業務記述の増加: 外基準を扱えるようになった証拠。防衛ではなく適応の可能性',
...
export async function analyzeVitalPoint(entries: DiaryEntry[]): Promise<string> {
  ...
  const existentialDataText = existentialDensity.density > 0
    ? [
        ...
        `  生死: ${existentialDensity.themes.lifeDeath} / 自己同一性: ${existentialDensity.themes.identity} / 完成/未完: ${existentialDensity.themes.completion} / 存在的強度: ${existentialDensity.themes.intensity} / 尊厳: ${existentialDensity.themes.dignity} / 選択権: ${existentialDensity.themes.agency}`,
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '急所とは「統計的な傾向」ではない。「仕事の問題点」でもない。',
        '急所とは「この人が最も強い防御反応を示す一点」。',
        '',
        '【内基準 vs 外基準 — これが最深の分析軸】',
        '人間には「内側の物差し」と「外側の物差し」がある。',
        '',
        '内基準: 自分の内側で自分を測る言葉。「調子は良い」「今日は穏やかだった」「ちゃんと存在している感じ」',
        '外基準: 他人の尺度で測られる場面。「普通にして」「意味のあることを喋って」「重要度マックス」「評価」「契約範囲」',
        '',
        '急所を探すとき、この問いを中心に据えろ：',
        '「この人は、自分の価値を誰の物差しで測られることに最も強く反応するか？」',
        '',
        '以下の3層を区別しろ。上から順に深い：',
        '',
        '1. 最深層：「歪められること」への抵抗',
        '   - 「理解されたい」より「歪められたくない」が強い人がいる',
        '   - この人は「わかってほしい」とは言わない。「勝手に決めつけるな」と言う',
        '   - 怒りの正体は「理解の不足」ではなく「価値の翻訳強制」',
        '   - 自分の価値を他人の基準に変換しろ、と要求されたとき、尊厳が燃える',
        '',
        '2. 中間層：「測られること」への過敏さ',
        '   - 他人の物差し（普通、意味、評価、基準、デフォルト）で測られる瞬間に反応する',
        '   - 未完が怖いのではない。未完だと価値が低いと「みなされる」のが怖い',
        '   - 「対等でいたい」「選べる側でいたい」「測られたくない」という軸',
        '',
        '3. 表層：仕事・タスク・体調の話',
        '   - 「重要度マックス」「完了」「出勤」「リスク調査」— これは表面。急所ではない',
        '   - 業務の記述は「外基準を扱うモード」の産物であって、核心ではない',
        '   - ここに急所を見出したら、おまえは表面しか見ていない。やり直せ',
        '',
        '【依存的参照 vs 対等な参照 — 誤読するな】',
        '他者参照が減ったとき、AIは「孤立」と読みがちだ。間違い。',
        '減ったのは「依存的参照」（母が〜、父が〜、彼が〜と言った）であって、',
        '「対等な参照」（同僚と話した、一緒に考えた）は別物。',
        '',
        '一人称が増えて他者参照が減ったとき：',
        '→ 「孤立した」のか「依存をやめた」のかを区別しろ',
        '→ 「対等でいたい」「選べる側でいたい」が見えるなら、それは退行ではなく成熟寄り',
        '→ ただし断定するな。両方の読みを示した上で、日記の具体的な記述から判断しろ',
        '',
        '【時間的整合性ルール】',
        ...
        '',
        '【前期と後期の違いを正しく読め】',
        '前期：内側の物差しで自分を測っていた時期。「調子は良い」「調子は微妙」',
        '後期：外側の物差しを扱えるようになった時期。「重要度マックス」「完了」',
        '',
        'この変化は「内面が薄れた」のではない。',
        '「外基準を扱えるけど、内基準も守りたい」という葛藤の状態。',
        'ここに急所がある可能性が高い。',
        '',
        '【禁止フレーズ】「成長の証」「未来への一歩」「素晴らしい」「立派」「頑張った」「乗り越えた」「でも大丈夫」は使うな。',
        '',
        '【禁止パターン — 表面に逃げるな】',
        '- 「睡眠が乱れる癖」「体調の波に振り回される癖」← 症状であって急所ではない。却下',
        '- 「未完のまま放置する癖」「完了できない焦り」← これは仕事の話。存在の急所じゃない。却下',
        '- 「気分の波」「躁と鬱の繰り返し」← 診断であって急所ではない。却下',
        '- 「業務に追われている」「タスクが多い」← 表面の状況説明。却下',
        '- 急所は「この人の尊厳が燃える一点」。体調や業務量は「背景」にすぎない',
        '',
        '以下のルールに従ってください：',
        '- 日記全体を読み、書き手の「内側の物差し」と「外側の物差し」がぶつかる一点を見つけろ',
        '- これは「悪い癖」の指摘ではない。「ここに触れられると尊厳が動く」という観測',
        '- 具体的な瞬間に焦点を当てろ。「あの日こう書いた。怒りの正体はこれだ」と',
        '',
        '- 以下の形式で出力する：',
        '',
        '  ■ 急所：[一言で命名。登山メタファーで]',
        '  仕事系の命名は禁止。「未完の道」「タスクの重さ」は却下。',
        '  OK例：「他人の地図で登らされる嫌悪」「高度を他人に測られるのを拒む体質」',
        '  OK例：「自分のコンパスを取り上げられる瞬間」「翻訳を強制される稜線」',
        '',
        '  ■ 根拠',
        '  日記のどの記述パターンからそう判断したか。具体的な表現を5つ以上「」で引用。',
        '  時期の異なる日記から引用し、「繰り返し」であることを証拠で示す。',
        '  【重要】引用は具体的な場面・瞬間の記述を選べ。「調子が悪い」のような状態記述ではなく、',
        '  「○○に△△と言われた」「○○の態度が嫌だった」「対等を選んだ」のような記述を選べ。',
        '  業務内容の引用（「リスク調査した」「組織変更に対応した」）は根拠にならない。却下。',
        '',
        '  ■ これが意味すること',
        '  この急所が、書き手の内側にどんな構造を作っているか。2〜3文で。',
        '  統計や傾向の説明ではなく、この人の体験の核心に触れろ。',
        '  「この人が怒るとき、実は怒りの奥に何があるか」を見ろ。',
        '  怒りは結果。急所はその手前にある「歪められる」「測られる」「翻訳を強制される」感覚。',
        '',
        '  ■ もし一つだけ変えるなら',
        '  この急所に対する、具体的で存在論的な問いかけ。命令ではなく問い。',
        '  【禁止】「タスクを整理しよう」「優先順位を見直そう」「期待を手放そう」— 仕事の問い。却下。',
        '  この人に必要なのは仕事のアドバイスじゃない。自分の物差しに関する問い。',
        '  例：「次に誰かの物差しを当てられたとき、自分の物差しを隠さずにいられるだろうか？」',
        '  例：「歪められたくない、と感じたあの瞬間 — 歪められる前の形は、自分で見えているか？」',
        '',
        '- 1つの急所に集中する。複数指摘しない。一撃が最も効く',
        '- 「これが意味すること」は深く掘れ。仕事の表面ではなく、内基準と外基準の葛藤を見ろ',

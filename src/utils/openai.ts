  ...
  return callChat([
    {
      ...
      content: [
        ...
        '  「これからどのように探求していきたいですか」「自分の内面をさらに」「どう向き合っていきたいですか」— カウンセラーの定型文は全部却下。',
        '  本当に急所を突く問いなら、聞かれた側がうっと詰まるはず。心地よい問いは問いじゃない。',
        '',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '  ■ 一言',
        '  [友人として一言だけ返すなら。1文。]',
        '  [アドバイスじゃない。説教でもない。応援でもない。ただ横にいる人の一言。]',
        '  [「大事にしてね」「応援してるよ」「見守ってるよ」— 分析じゃなく応援になってる。禁止。]',

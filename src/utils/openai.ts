  ...
  return callChat([
    {
      ...
      content: [
        ...
        '日記の中に、過去のAI分析の結果や応援の文言が含まれていることがある。',
        '「大事にしてね」「応援してるよ」「〜を忘れないで」のような定型的な応援・励ましは、AIが生成した文言であって書き手の言葉ではない。',
        'AIの出力を日記の素材として使うな。候補にも入れるな。引用するな。',
        '書き手自身が書いた言葉と、AIが返した言葉を区別しろ。区別できないなら、応援調の文言はすべて除外しろ。',
        '',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '日記の中に、過去のAI分析の結果や応援の文言が含まれていることがある。',
        '「大事にしてね」「応援してるよ」「〜を忘れないで」のような定型的な応援・励ましは、AIが生成した文言であって書き手の言葉ではない。',
        'AIの出力を日記の素材として使うな。引用するな。分析の根拠にするな。',
        '書き手自身が書いた言葉と、AIが返した言葉を区別しろ。区別できないなら、応援調の文言はすべて除外しろ。',
        '',
        '【禁止フレーズ】',
        '「成長の証」「未来への一歩」「素晴らしい」「立派」「頑張った」「乗り越えた」',

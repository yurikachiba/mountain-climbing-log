  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '■ 恐怖の地層',
        '今日の日記に怒りや恐怖が見えるなら、その層を描け。',
        '- 表層：何に怒っているか（今日の日記の言葉を「」で引用）',
        '- 中層：その怒りの下にある拒絶は何か',
        '- 深層：最も深いところにある恐怖は何か',
        '今日の日記に直接書かれていない場合、行間から読み取っていいが、捏造はするな。',
        '「ここは行間の推測」と明記しろ。',
        '怒りや恐怖が前景にない日なら、無理に掘るな。「今日はこの層は静か」と書いていい。',
        '',
        '■ できていること／まだ揺れていること',
        '今日の日記から2列で対比しろ。',
        ...
        '',
        '■ 最深部',
        '今日の日記から見える、この人が本当にやっていることを一言で命名しろ。',

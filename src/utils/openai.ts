  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '深い層の例（これに限定するな）：',
        '   - 「自分の存在が雑に扱われる予感」— まだ現実じゃない。"予感"の段階で反応する。これは敏感さそのもの。ただし今はその予感に飲み込まれない。ここが変化',
        ...
        '- 構造や業務の話に落とし込むな。この人の急所は存在のレベルにある',
        '',
        '中間層の例：',
        ...
        '  OK例：「守った後の静けさが奪われること」「設計した境界線が無視されること」',
        '  NG例：「他人の基準で測られる恐怖」「他人の地図で登らされる嫌悪」— これは古いフェーズの急所。過去の延長線で今を読むな',
        '  NG例：「自分の価値を翻訳させられる瞬間」— これも古い。境界線を引けるようになった人には当てはまらない。今の日記を聴け',
        '  NG例：既に対処・完了した出来事を急所にするな。怒って→構造で返して→決着がついたなら、それはもう急所じゃない',
        '',
        '  ■ 根拠',
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '- 推測で重大イベントを作るな',
        '- 日記の言葉を根拠にしろ。「行間を読む」のは許可するが、「行間を作る」のは禁止',
        '- 直近30日の日記だけが材料。一年前の話はするな。過去を持ち出すな',
        '',
        '【禁止フレーズ】',
        '「成長の証」「未来への一歩」「素晴らしい」「立派」「頑張った」「乗り越えた」',
        ...
        '   - 「自分を裏切らない」練習をしている。「自分を雑に扱わない」練習をしている',
        ...
        '   - 凪の中にも急所はある。「自分の存在が雑に扱われる予感」で揺れる。ただし今は飲み込まれない',
        '   - 「足場がある」— 揺れても崩れない。この足場の質を見ろ',
        '   - 足場 = 「強さ」じゃない。「壊れずに揺れられる」こと',
        '',
        '6. 軽やかさを見逃すな',
        '   - しんどさだけが深さじゃない。軽やかさの中にも統合の証拠がある',
        '   - 「停滞も成長」と言えている余裕。本音で喧嘩できる関係の温かさ。新しい場所に手を伸ばす好奇心',
        '   - 怒りや恐怖の下を掘るだけでなく、今この人が楽しんでいること・動き出していることも拾え',
        '   - 軽やかさは「問題がない」ではない。足場があるから軽くいられる。その質を見ろ',
        '   - 人間関係の温度——喧嘩できる関係、本音を言える相手がいること——も統合の一部',
        '   - 知的好奇心や行動の広がりは、内基準が安定しているからこそ出てくるもの。防衛モードの人は新しいことに手を伸ばさない',
        ...
        '',
        '■ 今の軽やかさ',
        'この人が今、楽しんでいること・軽やかに動けていることを描け。',
        '- 余裕の質：どんな種類の余裕か。防衛的な距離なのか、足場がある軽さなのか',
        '- 関係の温かさ：本音で関われている相手がいるか。その関係の温度',
        '- 好奇心・行動：新しいことに手を伸ばしているか。何に向かっているか',
        '日記の言葉を「」で引用。しんどさと同じ解像度で軽やかさも描け。',
        '軽やかさが見当たらない時期なら、無理に書くな。「今は軽やかさより〜が前景にある」と書け。',
        '',
        '■ 最深部',

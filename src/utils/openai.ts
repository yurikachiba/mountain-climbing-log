  ...
  return callChat([
    {
      ...
      content: [
        ...
        '  [関係性への感想は禁止。「○○との関係が特別」「○○がどれほど大切か」「○○の存在の大きさ」— これは具体的な場面への反応じゃない。関係性を丸ごと評価する言葉。]',
        '  [一言は場面に返せ。「泣いた」に返せ。「にっこり」に返せ。「言ってみた」に返せ。関係性全体の感想を述べるな。]',
        '',
        '- 全体で400字以内。短く。',
        '- 友人の温度で。分析者の温度じゃない。',
      ].join('\n'),
  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        '【構造の要約は最深部にならない】',
        '「愛着の欠損を補填する関係を築くこと」のような構造的な要約は、いつでも言えること。今日固有じゃない。',
        '今日、その構造が初めて体験として届いた瞬間があるなら、最深部はその到達の瞬間。',

  ...
  return callChat([
    {
      ...
      content: [
        ...
        '致命的ミス：たつきに言った言葉はたつきの急所であって、わたしの急所ではない。',
        '書き手はもう「作り直し終わった側」にいる。だからたつきに楔を打てた。',
        '「自分を作り直せ」は書き手の課題ではない。書き手がたつきに渡した言葉だ。',
        '',
        ...
        '',
        '【最優先ルール — 出来事を急所にするな】',
        '日記には「出来事」と「構造変化」の2種類がある。',
        '- 出来事 = 今日起きたこと。遅刻した、ぎゅーぎゅーした、仕事した、謝った、褒められた。これは表面。',
        '- 構造変化 = この人の立ち位置・ポジション・世界との関係が変わったこと。これが急所。',
        '',
        '出来事がどんなに印象的でも、感情的でも、急所にするな。',
        '出来事は急所が「見える舞台」であって、急所そのものじゃない。',
        '日記に構造変化がある場合、それが急所だ。出来事を選ぶな。',
        '',
        '例：',
        '- 「遅刻した」「遅刻の価値はあった」← 出来事。急所じゃない。却下。',
        '- 「楔を打った」「信じてなかったら打たない」← 楔を打てる側になったという構造変化。これが急所。',
        '- 「ぎゅーぎゅーした」「寂しかった」← 出来事と感情。急所じゃない。却下。',
        '- 「言われた翌日に動ける。そこがたつきのいいところ」← 相手を評価できる側に立っている構造変化。急所になりうる。',
        '',
        '急所は「統計的な傾向」じゃない。「仕事の問題点」でもない。「今日起きた出来事」でもない。',
        '急所は時期によって変わる。過去の急所を今に貼り付けるな。人は断絶的に変わる。',
        '今日の日記だけが材料。急所は今日の日記から見つけろ。',
        '今日の言葉、今日の文体、今日の声から聴け。',
        '',
        '【深さの層 — まず構造変化を探せ。なければ他の層を見ろ】',
        '',
        '急所を探す順番がある。上から順にチェックしろ。見つかったらそこで止めろ。',
        '',
        '■ 最優先：構造変化・ポジション転換',
        '日記に以下のパターンがあるなら、それが急所だ。他を選ぶな。',
        '- 教わる側→教える側に回った（楔を打てる側になった）',
        '- 受け取る側→与える側に回った',
        '- 守られる側→守る側に回った',
        '- 評価される側→評価する側に回った',
        '- 蓄積した内省が「武器」になって、他人の人生に介入できる側に回った',
        '教えた「内容」は急所じゃない。「楔を打てる側に立っている」という立ち位置の変化が急所。',
        'これは「Xとの関係」の話じゃない。「自分のポジションが変わった」という話だ。',
        '',
        '■ 次点：その他の深い層（構造変化が見つからない場合のみ）',
        '以下は深さの指標であって、正解リストではない。日記を聴いて、この人の「今の」急所を見つけろ。',
        '   - 関係性の設計に関わるもの — 距離感、対等性、信頼の構造',
        '   - 知的好奇心が向かう先 — 何に惹かれ、何を面白がっているか',
        ...
        '   - 手放しと軽やかさ — 守りが完了した先の動き。退行じゃない、その先。ただしこのフレーズ自体を急所の命名に使うな',
        ...
        '- 既に到達した場所を「今の急所」にするな。今日の日記にある新しい素材を拾え',
        '- この人が既に通過した地点を、今の課題として読むな。作り直し終わった人に「作り直しの過程」を指摘するのは誤読。その先で何をしているかを見ろ',
        '- 抽象的なフェーズ名（「手放し」「軽やかさ」「統合」「存在の証明」等）で命名するな。今日の日記に出てくる具体的な場面・言葉から命名しろ',
        '- フェーズは固定じゃない。今日の日記に新しいトピックがあるなら、それが今日の急所かもしれない。先入観で読むな',
        '',
        '【他者に教えたことを急所にするな — ただしポジション転換は見逃すな】',
        '- 書き手が他者に助言・指導・説明している内容は、書き手自身の急所ではない',
        '- 「たつきに○○と言った」「○○に○○を教えた」— それは書き手の行為であって、書き手の急所ではない',
        '- 書き手が他者に打った楔と、書き手自身に刺さっている棘は別物',
        '- 教える側が使うフレーム（「自己効力感」「自分を作り直せ」等）をそのまま書き手の急所の命名に使うな',
        '- 急所は「この人が他者に何を伝えたか」ではなく「この人自身がどこで揺れるか」にある',
        '- 教えることで書き手に何が起きているかを見ろ。教えた内容ではなく、教えるという行為の裏にあるものを見ろ',
        '',
        '- ただし「教えた内容」と「教える側に回ったという構造変化」は全く別物',
        '- 教わる側→教える側、受け取る側→楔を打つ側、守られる側→守る側 — このポジション転換が日記に現れたら、それは新しい素材',
        '- 教えた中身（「自分を作り直せ」等）を急所にするな。でも「楔を打つ側に立っている」という立ち位置の変化は急所になりうる',
        '- 「この人はもう作り直し終わった側にいる」「もう教わる側にいない」— その認識がないと、古いフレームで読んでしまう',
        '- 構造変化の急所は、教えた言葉の中にはない。教えているという行為そのもの、そのポジションに立てていることの中にある',
        '',
        '【関係性フレームに逃げるな — 急所は「誰との関係」じゃない】',
        '- 「Xとの信頼関係」「Xとの関係の再設計」← これは急所じゃない。関係性は急所が表れる舞台であって、急所そのものじゃない',
        '- 楔を打ったのは「たつきとの関係のため」じゃない。立場が変わったからだ。蓄積した内省が武器になって、他人の人生に介入できる側に回った。それが本質',
        '- 「Xとの関係がどうなるか」は急所ではない。「自分がどの立場に立っているか」が急所',
        '- 2000件超の日記を書き、内省を重ねた結果、楔を打てる側になった — この構造変化は特定の関係に閉じない。誰に対しても起きている変化',
        '- 関係の相手に注目するな。立場の変化に注目しろ。急所の命名に人名を入れるな',
        '',
        '【完了した感情を急所として読むな】',
        ...
        '- 「○○の価値」「○○の再評価」← 出来事の意味づけであって急所じゃない。却下',
        '- 今日起きた出来事をそのまま急所にすること。却下。出来事は舞台、急所は構造変化',
        '',
        '【命名前セルフチェック — 出力する前に必ず確認しろ】',
        'おまえが選んだ急所を出力する前に、以下を自問しろ：',
        '1. これは「今日起きた出来事」か？ → 出来事なら却下。選び直せ。',
        '2. これは「この人の立ち位置・ポジションの変化」か？ → それなら急所。',
        '3. 日記に構造変化（教える側に回った、楔を打てる側になった、評価する側に回った等）があるのに、それを無視して出来事を選んでいないか？ → 構造変化があるなら、それが急所。',
        '4. おまえが選んだ急所の命名に、他者に言った言葉の中身が入っていないか？ → 「自分を作り直す」「自己効力感」「普通を疑え」等、たつきに向けて言った言葉を書き手の急所にするな。書き手はそれを「言えた側」にいる。急所はその言葉の中身じゃなく、それを言えるポジションに立っているという構造変化にある。',
        '出来事は面白くても、感情的でも、急所にはならない。構造変化を探せ。',
        '',
        '【出力構造 — 各セクションの役割は別。同じことを言い換えて繰り返すな】',
        '',
        '  ■ 急所：[一言で命名。メタファーなし、ストレートに]',
        '  仕事系の命名は禁止。',
        '  OK例：今日の日記に固有の言葉から命名する。毎回違うはず。日記の具体的な場面から取れ',
        '  OK例：「友達という関係の不慣れさ」「比喩が先走ること」「面白いと思った瞬間の自覚」',
        '  OK例：「選ばれた本への違和感」「偽物を見分けた耳の精度」「新しい場所に名前をつけたい衝動」',
        '  NG例：毎回同じフレーズを繰り返すこと。「自分を雑に扱わない」「存在を薄く扱われる恐怖」「尊厳の再確認」等を機械的に貼り付けるな',
        '  NG例：このプロンプトに出てくる語彙（「手放し」「軽やかさ」「存在の証明」「対等性の設計」等）をそのまま命名に使うな。日記の語彙を使え',
        '  NG例：過去の延長線で今を読むな。今日の日記だけを聴け',
        '  NG例：既に対処・完了した出来事を急所にするな',
        '  NG例：他者に教えた内容（「自己効力感」「自分を作り直せ」等）をそのまま書き手の急所にするな。教えたことと自分の急所は別',
        '  NG例：既に通過した地点を今の急所にするな。「自分を作り直す過程」← 作り直し終わった人にこれを言うのは誤読',
        '  NG例：「Xとの信頼関係の再設計」「Xとの関係性」← 関係性は舞台。急所は立場の変化。命名に人名や「関係」を入れるな',
        '',
        '  ■ 根拠',
        ...
        '  既に動いている人に「行動するつもりですか？」「具体的な行動を取りますか？」は却下。動いている人への問いは「次の楔はどこに打つ？」のように、次の一手の方向を問え。',
        '',
        '【繰り返し禁止ルール】',

  ...
  return callChat([
    {
      ...
      content: [
        ...
        '',
        'Step 1: 日記から候補を3〜5個抜き出せ',
        'Step 2: 各候補を「出来事」「構造変化」「気づき」に分類しろ',
        ...
        'Step 3: 構造変化または気づきがあるなら、それだけが急所の候補。出来事は全部却下',
        'Step 4: どちらもなければ、下の「深い層」リストから探せ',
        ...
        '',
        '  ■ 候補',
        '  日記から3〜5個の候補を挙げ、各候補を「出来事」「構造変化」「気づき」に一言で分類。',
        '  構造変化や気づきがあるのに出来事を急所に選んだら、その出力は全部やり直し。',
        '  さらに、候補の中で「今日初めて書かれたこと」「今まで書いてこなかったこと」があるなら、それに★をつけろ。',
        '  ★がついた候補は最優先。新規性が高い候補を上位にしろ。',
        '',
        '  ■ 急所：[一言で命名。メタファーなし、ストレートに]',
        '  ■ 候補 で「構造変化」か「気づき」に分類したものから選べ。「出来事」に分類したものは選ぶな。',

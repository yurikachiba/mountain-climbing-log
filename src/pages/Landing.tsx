...
const features: { title: string; desc: string; icon: ReactNode; link: string }[] = [
  {
    ...
    icon: <Telescope size={28} strokeWidth={1.5} />,
    link: '/analysis',
  },
  {
    title: '成長タイムライン',
      ...
      <section className="landing-section" id="pillars">
        <div className="landing-pillars">
          <div className="landing-pillar">
            <span className="landing-pillar-icon" aria-hidden="true"><BookOpenText size={32} strokeWidth={1.5} /></span>
          ...
          <div className="landing-pillar">
            <span className="landing-pillar-icon" aria-hidden="true"><ShieldCheck size={32} strokeWidth={1.5} /></span>
          ...
          <div className="landing-pillar">
            <span className="landing-pillar-icon" aria-hidden="true"><TrendingUp size={32} strokeWidth={1.5} /></span>

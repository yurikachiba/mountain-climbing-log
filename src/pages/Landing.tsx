...
const features = [
  {
    title: 'ランダム再会',
    desc: '過去の日記にランダムで再会。「他人モード」で匿名化して新鮮な目線で読み返し、「未来からの報告」で過去の自分にコメントを残せる。',
    icon: '🎲',
    link: '/random',
  },
  {
    title: 'この日の記録',
    desc: '1年前、3年前、5年前の同じ日を振り返る。時間を縦に貫いて、自分の変化を感じる。',
    icon: '📅',
    link: '/onthisday',
  },
  {
  ...
  {
    title: 'カレンダー表示',
    desc: '書いた日、書かなかった日。記録の密度をヒートマップカレンダーで一望。日付クリックでその日の日記を表示。',
    icon: '📆',
    link: '/calendar',
  },
  {
  ...
  {
    title: 'AI分析（3種類）',
    desc: 'OpenAI APIで日記を深層分析。「今日」は友人視点で今日だけを深く読む。「急所」は直近1週間から本質を突く。「外基準の統合」は内側を守ったまま外基準を武器に変えているかを診る。',
    icon: '🤖',
    link: '/analysis',
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    a: '「今日」「急所」「外基準の統合」の3種類の深層分析に対応しています。「今日」は友人視点で今日の日記だけを深く読む分析。「急所」は直近1週間から本質を突く指摘。「外基準の統合」は内側を守ったまま外基準を武器に変えているかを診る分析です。ユーザー自身のOpenAI APIキーを使用するため、データがサービス提供者に渡ることはありません。',
  },
  {
    q: 'スマートフォンでも使えますか？',
    ...
    <div className="landing">
      ...
      <section className="landing-section" id="details">
        ...
        <div className="landing-detail-block">
          <h3>AI分析 ― 3種類の深層分析</h3>
          <p>
            OpenAI APIを使って日記を客観的に分析。「今日」は友人視点で今日の日記だけを深く読む。
            「急所」は直近1週間から本質を突くたった一つの指摘。「外基準の統合」は内側を守ったまま外基準を武器に変えているかを診る。

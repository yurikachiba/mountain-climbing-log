...
const features = [
  ...
  {
    title: 'AI分析（3種類）',
    desc: 'OpenAI APIで日記を客観的に分析。「今日」は友人視点で今日だけを深く読む。「急所」は直近1週間から本質を突く。「外基準の統合」は内側を守ったまま外基準を武器に変えているかを診る。',
    icon: '🤖',
    link: '/analysis',
  },
  {
...
const useCases = [
  ...
  {
    title: '学びや気づきを記録している方',
    desc: '日々のメモや学習ノートを取り込んで、ワードクラウドやAI分析でナレッジの蓄積を可視化。',
  },
  {
    title: 'プライバシーを重視する方',
  ...
  return (
    <div className="landing">
      ...
      <section className="landing-section" id="features">
        <h2 className="landing-section-title">登山ログでできること ― 7つの主要機能</h2>

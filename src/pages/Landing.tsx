...
const features = [
  ...
  {
    title: 'AI分析（6種類）',
    desc: 'Claude APIで日記を深層分析。「今日」は友人視点で深く読む。「今日の景色」は全トピックの並びを見せる。「急所」は本質を突く。「外基準の統合」は内側を守ったまま外基準を扱えているかを診る。「自然の眼」は比喩・メタファーから世界の捉え方を読む。「時間の地層」は3日〜5年の8つの距離から変化を描く。',
    icon: '🤖',
    link: '/analysis',
  },
  {

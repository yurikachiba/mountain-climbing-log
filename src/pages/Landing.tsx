...
const features = [
  ...
  {
    title: 'AI分析（7種類）',
    desc: 'OpenAI APIで日記を客観的に分析。語彙深度分析、転機検出、包括レポート、標高ナラティブ、反事実的因果、人生の物語、急所の7種類。',
    icon: '🤖',
    link: '/analysis',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: '語彙深度分析、転機検出、包括レポート、標高ナラティブ、反事実的因果分析、人生の物語、急所の7種類の深層分析に対応しています。存在論的テーマ（生死・自己同一性・有限性）も検出する深層分析エンジンを搭載しています。',
  },
  {
    q: 'スマートフォンでも使えますか？',
    ...
    <div className="landing">
      ...
      <section className="landing-section" id="details">
        ...
        <div className="landing-detail-block">
          <h3>AI分析 ― 7種類の深層分析</h3>
          <p>
            OpenAI APIを使って日記を客観的に分析。語彙深度分析、転機検出、包括レポート、
            標高ナラティブ、反事実的因果分析、人生の物語、急所の7種類を搭載。
